...
var InnerHeader = React.createClass({
    ...
    componentWillMount: function componentWillMount() {
        ...
        this.getSystemSettings(this.context.d2).then(this.getHeaderBarData).catch(this.loadDataFromLocalStorageIfAvailable).then(saveToLocalStorage).then(function (headerData) {
            _this.setHeaderData(headerData.userStyleUrl, headerData.title);
    ...
    componentDidMount: function componentDidMount() {
        ...
        Observable.fromEvent(window, 'resize').takeUntil(this.unmount).debounceTime(200).subscribe(function () {
    ...
    setHeaderData: function setHeaderData(userStyleUrl, title) {
