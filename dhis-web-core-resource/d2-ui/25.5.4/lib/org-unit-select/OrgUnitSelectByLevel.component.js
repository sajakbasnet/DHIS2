                ...
                if (_this2.props.currentRoot) {
                    var _ret = function () {
                        ...
                        d2.models.organisationUnits.list({
                            ...
                            log.debug('Loaded ' + orgUnitIds.length + ' org units for level ' + (relativeLevel + ' under ' + _this2.props.currentRoot.displayName));
...
OrgUnitSelectByLevel.propTypes = {
    ...
    currentRoot: function currentRoot(props, propName, componentName) {
        if (props[propName]) {
