    ...
    $.extend(PersianCalendar.prototype, {
        ...
        regional: {
            '': {
                name: 'Persian',
                epochs: ['BP', 'AP'],
                monthNames: ['Hamal', 'Sawr', 'Jawza', 'Saratan', 'Asad', 'Sunbula', 'Mizan', 'Aqrab', 'Qaws', 'Jadi' , 'Dalwa', 'Hoot'],
                monthNamesShort: ['Ham', 'Saw', 'Jaw', 'Sar', 'Asa', 'Sun', 'Miz', 'Aqr', 'Qaw', 'Jad', 'Dal', 'Hot'],
                dayNames: ['Yekshambe', 'Doshambe', 'Seshambe', 'Chaharshambe', 'Panjshambe', 'Jome', 'Shambe'],
